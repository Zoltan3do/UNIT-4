...
public class Application {
    ...
    public static void main(String[] args) {
    	...
    	Location location1 = new Location(1, "Stadio Olimpico", "Roma");
    	Location location2 = new Location(2, "Arena di Verona", "Verona");
    	dao.save(location1);
    	dao.save(location2);
    	...
    	Partecipazione partecipazione1 = new Partecipazione(1, persona1, concerto, Stato.CONFERMATA);
    	Partecipazione partecipazione2 = new Partecipazione(2, persona2, partita, Stato.DA_CONFERMARE);
